...
#                                                                             #src
# file: docs/lit/workshop_verification.jl                                     #src
# purpose: Literate.jl source of the verification notebook: the two-bus and   #src
#          four-bus hand calculations of theory Section 7 against the solver. #src
